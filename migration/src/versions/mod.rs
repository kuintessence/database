//! NOTE: You should obey [Rust 2018 submodule organization] under `versions`,
//! because sea-orm-migration requires the version to be a file instead of a directory.
//!
